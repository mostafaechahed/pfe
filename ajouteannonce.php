...
<body>
    <div id="container">
        <form name="formAdd" action="" enctype="multipart/form-data" method="POST" class="formulaire">
            <h2 align="center">Ajouter nouvelle annonce...</h2>
            <label for=""><b>idannonce:</b></label>
            <input type="text" name="id" class="zonetext" placeholder="" required><br>
            <label for=""><b>nome de l'annonce:</b></label>
            <input type="text" name="nom" class="zonetext" placeholder="Entrer le nom" required><br>
            <label for=""><b>la date de l'annonce:</b></label>
            ...
            <label for=""><b>text d'annonce:</b></label>
            <textarea type="textarea" name="textA" class="zonetext" placeholder="" rows="10" cols="500" required></textarea><br>
            <input type="submit" name="Ajouter" value="Ajouter" id="submit">
            <p><a href="administrateur.PHP" class="submit">liste d'annonces</a></p>
            <label for="" style="text-align:center;color:blue">
                <?php
                ...
                if (isset($_POST['Ajouter'])) {
                    ...
                    $nom = $_POST['nom'];
                    $date = $_POST['date'];
                    $textarea = mysqli_real_escape_string($cnassociation, $_POST['textA']);
                    $image = $_FILES['image']['tmp_name'];
                    $target = "img/" . $_FILES['image']['name'];
                    move_uploaded_file($image, $target);


                    $reqAdd = "INSERT INTO annonce(idannonce,nomannonce,date,imageA,textA) VALUES('$id','$nom','$date','$target','$textarea')";
